const translations = {
    de: {
        ...
        // UGC Page
        ugc_title: "UGC Creators gesucht",
        ugc_hero_title: "[BEZAHLT] Wir suchen UGC Creator für unsere KI-Lern-App",
        ugc_intro: "Hey zusammen 👋 Wir sind zwei Indie-Entwickler, die eine kleine KI-Nachhilfe-App für Schüler bauen, und wir suchen Creators, die gerne Short-Form-Videos (TikTok, Reels, Shorts) erstellen.",
        ugc_test_clips: "Wir möchten tägliche kurze Clips zu den Themen Lernen, Hausaufgaben, Motivation, „POV Schülerleben“ oder Reaktionen auf die App testen. Nichts Skriptiertes, einfach natürlicher Content.",
        ugc_offer_title: "Was wir bieten",
        ugc_offer_1: "• 10€ pro Video",
        ugc_offer_2: "• Leistungsbasierte Boni für Videos, die gut performen",
        ugc_offer_3: "• Langfristige Zusammenarbeit, wenn es passt",
        ugc_do_title: "Was du tun würdest",
        ugc_do_1: "• 1 kurzes Video pro Tag (15–60 Sek.)",
        ugc_do_2: "• Einfache Sachen: Screen Recording, POV, Reaktionen, Study Vibes",
        ugc_do_3: "• Der Content wird auf unseren eigenen TikTok/Reels Accounts genutzt (du musst nichts auf deinem eigenen Account posten)",
        ugc_no_follower: "Keine Follower-Anforderung – uns geht es um Authentizität, nicht um die Größe deiner Audience.",
        ugc_apply_text: "Wenn du interessiert bist, schreib uns eine E-Mail mit deinem Portfolio an:",
        ugc_apply_button: "E-Mail an friedrich@tutor.new",
    ...
    en: {
        ...
        // UGC Page
        ugc_title: "UGC Creators wanted",
        ugc_hero_title: "[PAID] Looking for UGC creators for a small AI tutoring app",
        ugc_intro: "Hey everyone 👋 We’re two indie devs building a small AI tutoring app for middle & high school students, and we’re looking for creators who enjoy making short-form videos (TikTok, Reels, Shorts).",
        ugc_test_clips: "We want to test daily short clips around studying, homework, motivation, “POV student life”, or reacting to the app. Nothing scripted, just natural content.",
        ugc_offer_title: "What we offer",
        ugc_offer_1: "• $10 per video",
        ugc_offer_2: "• Performance-based bonuses for videos that do well",
        ugc_offer_3: "• Long-term collab if it’s a good fit",
        ugc_do_title: "What you’d do",
        ugc_do_1: "• 1 short video per day (15–60s)",
        ugc_do_2: "• Simple stuff: screen recording, POV, reactions, study vibes",
        ugc_do_3: "• Content will be used on our own TikTok/Reels accounts (you don’t need to post on your main)",
        ugc_no_follower: "No follower requirement — we care about authenticity, not audience size.",
        ugc_apply_text: "If you’re interested, apply by sending an email with your portfolio to:",
        ugc_apply_button: "Email to friedrich@tutor.new",
